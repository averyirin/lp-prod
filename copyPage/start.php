...
function pages_init() {
	...
	elgg_register_action("annotations/page/restore", "$action_base/annotations/page/restore.php");
...
function pages_entity_menu_setup($hook, $type, $return, $params) {
	...
	$options = array(
		'name' => 'copy',
		'text' => elgg_echo('pages:copy'),
		'href' => "pages/add/$entity->container_guid/$entity->guid",
		'priority' => 151,
	);
	$return[] = ElggMenuItem::factory($options);
	return $return;
