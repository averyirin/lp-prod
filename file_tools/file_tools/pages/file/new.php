<?php 
	...
	if(!empty($page_owner))	{
		...
		$body .= "</div>
				...
				<script src='$wettoolkit_url/js/controllers/FileController_v2_0.js'></script>
				<script src='$wettoolkit_url/js/directives/FileDirective_v2_0.js'></script>
				<script src='$wettoolkit_url/js/services/FileService_v2_0.js'></script>
                ...
                <script src='$wettoolkit_url/js/services/EntityService_v2_0.js'></script>";
