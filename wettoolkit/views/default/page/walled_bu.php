...
<link rel="stylesheet" href="<?php echo $wettoolkit_url.'/css/styles.min.css?v1.2';?>"/>
...
<link rel="stylesheet" href="<?php echo $wettoolkit_url.'/dist/theme-gcwu-fegc/css/theme-min.css?v1.2';?>" />
...
<script src="<?php echo $wettoolkit_url.'/dist/js/wg-script.min.js?v1';?>"></script>
