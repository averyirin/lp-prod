	...
	angular
		...
		function Projects(resolveProject, project, user, notification, $location, Upload, $routeParams, $rootScope, helper, DTOptionsBuilder, $q, $sce) {
            ...
            vm.print = function() {
                ...
                var popupWin = window.open('', '_blank', 'width=1024,height=778');
                popupWin.document.open();
                popupWin.document.write('<html><head><style>body{font-family:sans-serif;} p{margin:.667rem 0 2.25rem;}</style></head><body onload="window.print()">' + printContents + '</body></html>');
