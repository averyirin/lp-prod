(function(){
	...
	angular
		...
		function Projects(resolveProject, project, user, notification, $location, Upload, $routeParams, $rootScope, helper, DTOptionsBuilder, $q, $sce) {
			...
			vm.department_options = {"values":[elgg.echo('projects:unassigned'),elgg.echo('projects:owner:learning_technologies'),elgg.echo('projects:owner:lsc'), elgg.echo('projects:owner:alsc'), elgg.echo('projects:owner:modernization'), elgg.echo('projects:owner:programmes'), elgg.echo('projects:owner:lt_lsc')]};
            ...
            vm.choices = {"projects:savings:productivityIncrease":{"title":elgg.echo('projects:savings:productivityIncrease')}, "projects:savings:reduction":{"title":elgg.echo('projects:savings:reduction')},
                                    "projects:savings:rationalization":{"title":elgg.echo('projects:savings:rationalization')}, "projects:savings:qualitative":{"title":elgg.echo('projects:savings:qualitative')}};
