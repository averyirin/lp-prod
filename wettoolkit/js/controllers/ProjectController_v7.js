	...
	angular
		...
		function Projects(resolveProject, project, user, notification, $location, Upload, $routeParams, $rootScope, helper, DTOptionsBuilder, $q, $sce) {
            ...
            vm.print = function() {
                ...
                popupWin.document.write('<html><head><style>body{font-family:sans-serif; margin:1rem 2.25rem;} p{margin:.667rem 0 2.25rem; white-space: pre-wrap;}</style></head><body onload="window.print()">' + printContents + '</body></html>');
