...
<script type='text/javascript' src='https://l-lin.github.io/angular-datatables/dist/angular-datatables.min.js'></script>
<script src='/portal/node_modules/crypto-js/crypto-js.js'></script>
<script src='$pluginUrl/js/app_v2_0.js'></script>
<script src='$wettoolkit_url/js/controllers/ProjectController_v2_0.js'></script>
<script src='$wettoolkit_url/js/controllers/UserController_v2_0.js'></script>
<script src='$wettoolkit_url/js/controllers/UsersController_v2_0.js'></script>
<script src='$wettoolkit_url/js/directives/ProjectDirective_v2_0.js'></script>
<script src='$wettoolkit_url/js/services/ProjectService_v2_0.js'></script>
<script src='$wettoolkit_url/js/services/UserService_v2_0.js'></script>
<script src='$wettoolkit_url/js/services/NotificationService_v2_0.js'></script>
