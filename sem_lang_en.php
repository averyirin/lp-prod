...
. " three sections:
	...
	'admin:plugins:disablestale_all' => 'Disable Stale Plugins',
	'admin:usermgmt' => 'User Management',
	"semadd" => "Create SEM account",
	'admin:users:semadd' => "Create SEM account",
	"semname" => "Subject's name (will be converted to username)",
	"svc" => "SVC (will be converted to a @forces email)",
